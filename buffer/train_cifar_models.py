...
def train(args, channel, num_classes, im_size, trainloader, testloader):
    ...
    for e in range(args.train_epochs):
        ...
        if test_acc > best_acc:
            best_acc = test_acc
            save_path = os.path.join(args.save_dir, "{}_best.pt".format(args.model, e))
            torch.save(teacher_net.state_dict(), save_path)
...
def main(args):
    ...
    train(args, channel, num_classes, im_size, trainloader, testloader)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='./buffers', help='buffer path')
